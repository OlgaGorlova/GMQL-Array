...
public class gCoords extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3401600260176989621L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"gCoords\",\"namespace\":\"it.polimi.genomics.avro.garray2\",\"fields\":[{\"name\":\"chr\",\"type\":\"string\"},{\"name\":\"start\",\"type\":\"long\"},{\"name\":\"stop\",\"type\":\"long\"},{\"name\":\"strand\",\"type\":\"string\"}]}");
   ...
   */
  public static it.polimi.genomics.avro.garray2.gCoords.Builder newBuilder() {
    return new it.polimi.genomics.avro.garray2.gCoords.Builder();
  }
   ...
   * @return A new gCoords RecordBuilder
   */
  public static it.polimi.genomics.avro.garray2.gCoords.Builder newBuilder(it.polimi.genomics.avro.garray2.gCoords.Builder other) {
    if (other == null) {
      return new it.polimi.genomics.avro.garray2.gCoords.Builder();
    } else {
      return new it.polimi.genomics.avro.garray2.gCoords.Builder(other);
    }
  }
   ...
   * @return A new gCoords RecordBuilder
   */
  public static it.polimi.genomics.avro.garray2.gCoords.Builder newBuilder(it.polimi.genomics.avro.garray2.gCoords other) {
    if (other == null) {
      return new it.polimi.genomics.avro.garray2.gCoords.Builder();
    } else {
      return new it.polimi.genomics.avro.garray2.gCoords.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<gCoords>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.polimi.genomics.avro.garray2.gCoords.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.polimi.genomics.avro.garray2.gCoords other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.chr)) {
        this.chr = data().deepCopy(fields()[0].schema(), other.chr);
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder setChr(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder clearChr() {
      chr = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder setStart(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder clearStart() {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder setStop(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder clearStop() {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder setStrand(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray2.gCoords.Builder clearStrand() {
      strand = null;
