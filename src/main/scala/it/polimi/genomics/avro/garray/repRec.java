...
public class repRec extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6309941973002813612L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"repRec\",\"namespace\":\"it.polimi.genomics.avro.garray\",\"fields\":[{\"name\":\"repArray\",\"type\":{\"type\":\"array\",\"items\":\"double\"}}]}");
   ...
   */
  public static it.polimi.genomics.avro.garray.repRec.Builder newBuilder() {
    return new it.polimi.genomics.avro.garray.repRec.Builder();
  }
   ...
   * @return A new repRec RecordBuilder
   */
  public static it.polimi.genomics.avro.garray.repRec.Builder newBuilder(it.polimi.genomics.avro.garray.repRec.Builder other) {
    if (other == null) {
      return new it.polimi.genomics.avro.garray.repRec.Builder();
    } else {
      return new it.polimi.genomics.avro.garray.repRec.Builder(other);
    }
  }
   ...
   * @return A new repRec RecordBuilder
   */
  public static it.polimi.genomics.avro.garray.repRec.Builder newBuilder(it.polimi.genomics.avro.garray.repRec other) {
    if (other == null) {
      return new it.polimi.genomics.avro.garray.repRec.Builder();
    } else {
      return new it.polimi.genomics.avro.garray.repRec.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<repRec>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.polimi.genomics.avro.garray.repRec.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.polimi.genomics.avro.garray.repRec other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.repArray)) {
        this.repArray = data().deepCopy(fields()[0].schema(), other.repArray);
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray.repRec.Builder setRepArray(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.polimi.genomics.avro.garray.repRec.Builder clearRepArray() {
      repArray = null;
