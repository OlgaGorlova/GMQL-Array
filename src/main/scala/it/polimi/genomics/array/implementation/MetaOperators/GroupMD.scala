...
object GroupMD {
  ...
  def apply(executor: GMQLArrayExecutor, groupingKeys : MetaGroupByCondition, aggregates : Option[List[MetaAggregateFunction]], newGroupNameInMeta : String, inputDataset : MetaOperator, regionDataset : RegionOperator, sc: SparkContext): RDD[MetaType] = {
...
//    import it.polimi.genomics.array.implementation.MetaOperators.GroupOperator.MetaGroupMGD._
//
//    //(sampleId, GroupIds)
