...
case class GArray2 (key:GRegionKey2,values:GAttributes)
  extends Serializable {

  def _1: GRegionKey2 = key
  def _2: GAttributes = values

  def this() = this(new GRegionKey2("chr", 0, 0, "."), new GAttributes(Array[(Long,Int)](), Array[Array[Array[it.polimi.genomics.core.GValue]]]()))
